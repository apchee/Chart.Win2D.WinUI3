...
namespace Microsoft.Toolkit.Uwp.UI.Media.Geometry.Parsers
{
    ...
    /// </summary>
    public static class CanvasBrushParser
    {
        /// <summary>
        ...
        public static ICanvasBrushElement Parse(string brushData)
        {
        ...
        public static ICanvasBrush Parse(ICanvasResourceCreator resourceCreator, string brushData)
        {

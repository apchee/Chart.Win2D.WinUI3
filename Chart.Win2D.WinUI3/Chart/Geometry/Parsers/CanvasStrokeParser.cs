...
namespace Microsoft.Toolkit.Uwp.UI.Media.Geometry.Parsers
{
    ...
    /// </summary>
    public static class CanvasStrokeParser
    {
        /// <summary>
        ...
        public static ICanvasStrokeElement Parse(string strokeData)
        {
        ...
        public static ICanvasStroke Parse(ICanvasResourceCreator resourceCreator, string strokeData)
        {
